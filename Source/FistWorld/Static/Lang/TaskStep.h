...
const FText txtSetSoldierNum = NSLOCTEXT( "TaskStep", "SETTING_SOLDIER_NUMBER", "设置士兵数量" );
const FText txtFinished = NSLOCTEXT( "TaskStep", "FINISHED", "已完成" );
const FText txtCanceled = NSLOCTEXT( "TaskStep", "CANCELED", "已取消" );
const FText txtUnkown = NSLOCTEXT( "TaskStep", "INVALID", "未知步骤" );