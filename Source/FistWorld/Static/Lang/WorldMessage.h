...
const FText txtDeploymentStart = NSLOCTEXT( "WorldMessage", "DeployingWarriors", "部队已出发" );
const FText txtTrasportStart = NSLOCTEXT( "WorldMessage", "TrasportingMoneyAndFood", "运输队已出发" );
